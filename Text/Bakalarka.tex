...
\Autor{Vojtěch Liška}{Vojtěch Liška}

\NazevPrace{Prostorový modulátor světla}{Prostorový modulátor světla}{Spatial light modulator}
...
\VedouciPraceSTituly{prof. Mgr. Tomáš Tyc, Ph.D.} %% Neni potreba pro rigorozni prace
...
\KlicovaSlova{SLM; prostorový modulátor světla; Fourierovská optika; fázové hologramy; Fourierova transformace; DFT}{SLM; spatial light modulator; Fourier optics; phase holograms; Fourier transform; DFT}

\Abstrakty%
{V této bakalářské práci se věnujeme ...}%
...
\TextProhlaseni%
{Prohlašuji, že jsem svoji bakalářskou/diplomovou/rigorózní práci vypracoval samostatně s~využitím informačních
zdrojů, které jsou v práci citovány.}

\DatumProhlaseni{18. května 2017}
...
\HlavickaKapitoly
\vloz{text_prace/06_Kapitola_04}
\cleardoublepage

\HlavickaKapitoly
\vloz{text_prace/07_Kapitola_05}
\cleardoublepage

\HlavickaZaver
% \pdfbookmark{Závěr}{Zaver}
\vloz{text_prace/08_Zaver}
\cleardoublepage
